...
function viewChat(instance_id, url)
{
   ...
   win.document.writeln('<body>');
   win.document.writeln('<applet codebase="'+url+'" archive="http://www.clonegene.com/scripts/multichat.jar" CODE="GUIClient.class" width="562" height="385" align="BOTTOM">');
   win.document.writeln('<param name="CABBASE" value="http://www.clonegene.com/scripts/multichat.cab">');
